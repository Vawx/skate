...
/*
    ...
    float shadow_csm(vec3 world_position, vec3 world_normal, inout int casecade_idx)
    {
        ...
        _350.x = _216.x;
        _350.y = _216.y;
        vec3 param_1 = vec3((_350.xy * 0.5) + vec2(0.5), (_216.z * 0.5) + 0.5);
...
static const uint8_t texture_static_mesh_fs_source_glsl430[3136] = {
    ...
    0x63,0x34,0x20,0x5f,0x33,0x36,0x32,0x3b,0x0a,0x0a,0x75,0x6e,0x69,0x66,0x6f,0x72,
    ...
    0x30,0x3b,0x0a,0x20,0x20,0x20,0x20,0x5f,0x33,0x35,0x30,0x2e,0x78,0x20,0x3d,0x20,
    0x5f,0x32,0x31,0x36,0x2e,0x78,0x3b,0x0a,0x20,0x20,0x20,0x20,0x5f,0x33,0x35,0x30,
    ...
    0x76,0x65,0x63,0x33,0x28,0x28,0x5f,0x33,0x35,0x30,0x2e,0x78,0x79,0x20,0x2a,0x20,
...
/*
    ...
    float shadow_csm(float3 world_position, float3 world_normal, inout int casecade_idx)
    {
        ...
        _350.x = _216.x;
        _350.y = _216.y;
        float3 param_1 = float3((_350.xy * 0.5f) + 0.5f.xx, (_216.z * 0.5f) + 0.5f);
        int param_2 = casecade_idx;
        float2 param_3 = 1.0f.xx / max(float2(_51_cascade_splits_shadow_map_size[casecade_idx].x, _51_cascade_splits_shadow_map_size[casecade_idx].y), 1.0f.xx);
...
static const uint8_t texture_static_mesh_fs_source_hlsl5[3654] = {
    ...
    0x36,0x32,0x3b,0x0a,0x0a,0x63,0x62,0x75,0x66,0x66,0x65,0x72,0x20,0x74,0x65,0x78,
    0x74,0x75,0x72,0x65,0x5f,0x73,0x74,0x61,0x74,0x69,0x63,0x5f,0x6d,0x65,0x73,0x68,
    ...
    0x33,0x35,0x30,0x3b,0x0a,0x20,0x20,0x20,0x20,0x5f,0x33,0x35,0x30,0x2e,0x78,0x20,
    0x3d,0x20,0x5f,0x32,0x31,0x36,0x2e,0x78,0x3b,0x0a,0x20,0x20,0x20,0x20,0x5f,0x33,
    0x35,0x30,0x2e,0x79,0x20,0x3d,0x20,0x5f,0x32,0x31,0x36,0x2e,0x79,0x3b,0x0a,0x20,
    0x20,0x20,0x20,0x66,0x6c,0x6f,0x61,0x74,0x33,0x20,0x70,0x61,0x72,0x61,0x6d,0x5f,
    0x31,0x20,0x3d,0x20,0x66,0x6c,0x6f,0x61,0x74,0x33,0x28,0x28,0x5f,0x33,0x35,0x30,
...
/*
    ...
    float shadow_csm(thread const float3& world_position, thread const float3& world_normal, thread int& casecade_idx, constant texture_static_mesh_fs_params& _51, texture2d_array<float> shadow_tex, sampler shadow_smp)
    {
        ...
        _350.x = _216.x;
        _350.y = _216.y;
        float3 param_1 = float3((_350.xy * 0.5) + float2(0.5), (_216.z * 0.5) + 0.5);
        int param_2 = casecade_idx;
        float2 param_3 = float2(1.0) / fast::max(float2(_51.cascade_splits_shadow_map_size[casecade_idx].x, _51.cascade_splits_shadow_map_size[casecade_idx].y), float2(1.0));
...
static const uint8_t texture_static_mesh_fs_source_metal_macos[3848] = {
    ...
    0x6e,0x74,0x20,0x66,0x6c,0x6f,0x61,0x74,0x34,0x20,0x5f,0x33,0x36,0x32,0x20,0x3d,
    ...
    0x61,0x74,0x34,0x20,0x5f,0x33,0x35,0x30,0x3b,0x0a,0x20,0x20,0x20,0x20,0x5f,0x33,
    0x35,0x30,0x2e,0x78,0x20,0x3d,0x20,0x5f,0x32,0x31,0x36,0x2e,0x78,0x3b,0x0a,0x20,
    0x20,0x20,0x20,0x5f,0x33,0x35,0x30,0x2e,0x79,0x20,0x3d,0x20,0x5f,0x32,0x31,0x36,
    ...
    0x28,0x5f,0x33,0x35,0x30,0x2e,0x78,0x79,0x20,0x2a,0x20,0x30,0x2e,0x35,0x29,0x20,
