...
#if __cplusplus
um_inline um_vec2 um_v2(float x, float y) {
	um_vec2 result;
	result.x = x;
	result.y = y;
	return result;
}
um_inline um_vec3 um_v3(float x, float y, float z) {
	um_vec3 result;
	result.x = x;
	result.y = y;
	result.z = z;
...
um_inline um_vec4 um_v4(float x, float y, float z, float w) {
	um_vec4 result;
	result.x = x;
	result.y = y;
	result.z = z;
...
um_inline um_quat um_quat_xyzw(float x, float y, float z, float w) {
	um_quat result = {};
	result.x = x;
	result.y = y;
	result.z = z;
...
um_inline um_mat um_mat_rows(float m11, float m12, float m13, float m14, float m21, float m22, float m23, float m24, float m31, float m32, float m33, float m34, float m41, float m42, float m43, float m44) {
	um_mat result = {};
	result.m11 = m11;  result.m21 = m21; result.m31 = m31; result.m41 = m41;
	result.m12 = m12;  result.m22 = m22; result.m32 = m32; result.m41 = m42;
	result.m13 = m13;  result.m23 = m23; result.m33 = m33; result.m41 = m43;
	result.m14 = m14;  result.m24 = m24; result.m34 = m34; result.m41 = m44;
	return result;
}

um_inline um_mat um_mat_cols(float m11, float m21, float m31, float m41, float m12, float m22, float m32, float m42, float m13, float m23, float m33, float m43, float m14, float m24, float m34, float m44) {
	um_mat result = {};
	result.m11 = m11;  result.m21 = m21; result.m31 = m31; result.m41 = m41;
	result.m12 = m12;  result.m22 = m22; result.m32 = m32; result.m41 = m42;
	result.m13 = m13;  result.m23 = m23; result.m33 = m33; result.m41 = m43;
...
#else
#define um_v2(a, b) ((um_vec2){ .x = (a), .y = (b) })
#define um_v3(a, b, c) ((um_vec3){ .x = (a), .y = (b), .z = (c) })
#define um_v4(a, b, c, d) ((um_vec4){ .x = (a), .y = (b), .z = (c), .w = (d) })
